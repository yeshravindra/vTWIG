...
ytVideoApp.sendRequest = function(filePath, params, resultDivName) {
  ...
  xmlhr.onreadystatechange = function() {
    ...
    if (xmlhr.readyState == 1) {
      resultDiv.innerHTML = '<div id="loading_box"><b>Loading...</b></div>'; 
...
ytVideoApp.prepareUploadForm = function() { 
  var  metaDataForm = ['<br clear="all"><form id="uploadForm" ',
    ...
    'return false;">',
    'Name Your Video:<br /><input size="50" name="videoTitle" ',
    'type="text" /><br />',
    'Video description:<br /><textarea cols="50" ',
    'name="videoDescription"></textarea><br />',
    'Select a YouTube category (Categorize your video on YouTube): <select name="videoCategory" >',
    ...
    '</select><br />',
    'Tag your video for YouTube search ',
    '<em>(separated by spaces)</em>:<br />',
    '<input name="videoTags" type="text" size="50" value="video" /><br />',
    '<input id="you_submit_button" class="button_style1" type="submit" value="Continue to choose a Video">',
    '</form>'].join('');
